/*
 * Nombre: Luis Mario Torres Solis
 * Matrícula: A01797386
 * Materia: Cómputo en la nube
 * Actividad: Programación de una solución paralela
 * * NOTA DE COMPILACIÓN:
 * Este programa utiliza la librería OpenMP. Para que funcione el paralelismo
 * correctamente, se debe compilar agregando la bandera -fopenmp.
 * Ejemplo en terminal: g++ main.cpp -o tarea -fopenmp
 */
